<?php $page="enInstance-project-proposals";?>
@extends('layout.mainlayout')
@section('content')		


<!-- Page Content -->			
			<div class="content" style="padding : 190px 0px;">
						...
						<div class="col-xl-9 col-md-8">
							...
							<nav class="user-tabs mb-4">
								<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
									<li class="nav-item">
										<a class="nav-link" href="apprenant-projetsvalides">Projets validés</a>
									</li>
									<li class="nav-item">
										<a class="nav-link active" href="projetsenInstance">Projets en instance</a>
									</li>
								</ul>
							</nav> 
											...
											<div class="proposals-detail">
												...
												<div class="proposals-content">
													...
													<div class="proposal-client">
														<h4 class="title-info" style="color:#1c66b6; ">
															@if(strlen($project->name)<20){{ $project->name }}
															
														@else{{ substr($project->name, 0, 16).'...'}}@endif</h4>
												...
												<div class="proposal-img">
													...
													<h4>Coach</h4>
														...
														<span class="info-btn" style="background: #fffd9fd8 !important; color: #212529;">En-instance</span>
													</div>
												</div>
												</div>
											</div>
											...
											<a href="developer-details">{{$project->repoLink}} </a>
												...
												<div class="projects-action text-center">
													...
													<form action="{{ route('project-update') }}" method='POST'>
														@csrf
														<div>
															<input   type="hidden" name="idProjet" value="{{$project->id}}" style=" margin-right: 5%;" />
														<input class="projects-btn" type="submit" style="background: #454e50; border: none" value="Modifier le projet"/>
														</div>
													</form>
													{{-- <a href="{{ route('project-update', $project->id) }}" class="projects-btn">Modifier le projet</a> --}}
												</div>
											</div> 
										</div>
